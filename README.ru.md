...
Программа оптимизирована под **предельно возможную производительность на лоальном железе**.
