...
Альтернативы **precizer** с открытыми архитектурами и кодом.
...
* **hashdeep (md5deep/sha*deep)** — https://github.com/jessek/hashdeep
  ...
  * Написана на: C++/C, последние изменения 9 лет назад
    * Выбор семейства хэшей/форматов вывода (не привязан только к SHA512) — удобно, когда нужно соответствовать внешним требованиям/стандартам.
...
* **WinMerge** — https://winmerge.org/
  * Платформы/архитектуры: Windows (x86_64)
  * Написана на: C++, поддерживается
    * GUI-only
    * Визуальный интерактивный diff/merge (полезно, когда надо «посмотреть и руками слить»)
    * Не про криптографическую верификацию больших деревьев через БД/снапшоты; другой сценарий использования.
