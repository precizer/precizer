...
static Return test0008_1(void)
{
	INITTEST;
	create(char,captured_stdout);
	create(char,captured_stderr);
	create(char,pattern);
	const char *filename = "templates/0008_001.txt";
	...
	ASSERT(SUCCESS == match_pattern(captured_stderr,pattern,filename));
...
static Return test0008_2(void)
{
	...
	create(char,captured_stderr);
	create(char,pattern);
	const char *filename = "templates/0008_002.txt";
	...
	ASSERT(SUCCESS == match_pattern(captured_stdout,pattern,filename));
...
static Return test0008_3(void)
{
	...
	create(char,captured_stderr);
	create(char,pattern);
	const char *filename = "templates/0008_003.txt";

	ASSERT(SUCCESS == function_capture(serp_case,captured_stdout,captured_stderr));
...
Return test0008(void)
{
	...
	TEST(test0008_1,"librational test report messaging…");
	TEST(test0008_2,"librational test slog messaging…");
	TEST(test0008_3,"librational test serp messaging…");
