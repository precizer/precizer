...
4. [Слои статусов](#слои-статусов)
5. [Базовая функция](#базовая-функция)
6. [Функция-проверка с YES и NO](#функция-проверка-с-yes-и-no)
7. [Как правильно разбирать результат](#как-правильно-разбирать-результат)
8. [Последовательные проверки через status](#последовательные-проверки-через-status)
9. [Цепочки вызовов: run() и call()](#цепочки-вызовов-run-и-call)
10. [Глобальный статус](#глобальный-статус)
11. [Технические подробности](#технические-подробности)
12. [Практические правила](#практические-правила)
